...
<body class="bg-black-alt font-sans leading-normal tracking-normal">
        ...
        <div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
            ...
            <div class="w-1/2 pl-2 md:pl-0">
                <a class="text-gray-100 text-base xl:text-xl no-underline hover:no-underline font-bold" href="#">
                    <i class="fa-solid fa-scale-balanced text-blue-400 pr-3"></i> DEFCON
                </a>
            </div>
                ...
                <div class="flex relative inline-block float-right">
                    ...
                    <div class="relative text-sm text-gray-100">
                        ...
                        <div id="userMenu"
                            ...
                            <ul class="list-reset">
                                <li><a href="CarregarConsumidor?idPessoa=<%=pessoa.getIdPessoa()%>"
    ...
    <div class="container w-full mx-auto pt-20">
        <form name="cadastrar" action="CadastrarPostagemConsumidor" method="POST" class="w-full p-4">
              <div class="mb-2 mt-3">
                <input name="tituloPostagem" type="text" class="p-2 border rounded focus:outline-none focus:ring-gray-300 focus:ring-1 my-2" placeholder="Título">
                <textarea name="descricaoPostagem"
                  class="w-full h-20 p-2 border rounded focus:outline-none focus:ring-gray-300 focus:ring-1"
                  placeholder="Descrição"></textarea>
              </div>
              <div>
                  <button type="submit" name="cadastrar" class="px-3 py-2 text-sm text-blue-100 bg-blue-600 rounded">Postar</button>
              </div>
            </form>
        <div class="w-full px-4 md:px-0 md:mt-8 mb-8 text-gray-800 leading-normal">
            ...
            <div class="grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-3 xl:max-w-full">
                <!-- Tile 2 -->
                <%
            ...
            %>
                <div class="flex bg-gray-200 rounded-lg p-4 m-2">
                    <div class="flex flex-col items-start ml-4">
                        <h4 class="text-xl font-semibold"><%=postagem.getTituloPostagem()%></h4>
                        <p class="text-sm"><%=postagem.getDescricaoPostagem()%></p>
                        <a class="p-2 leading-none rounded font-medium mt-3 bg-gray-400 text-xs uppercase"
                            href="ListarComentarioConsumidor?idPostagem=<%=postagem.getIdPostagem()%>">Comentários</a>
                    </div>
                </div>
                            <%
                                }
