<%-- 
    Document   : alterarConsumidor
    Created on : 5 de dez de 2022, 09:12:28
    Author     : Aluno
--%>
        ...
        <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                    ...
                    <li class="mr-6 my-2 md:my-0">
                        <a href="ListarAdvogado"
                            ...
                            <i class="fa fa-envelope fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Advogados</span>
                        </a>
                    </li>
                    <li class="mr-6 my-2 md:my-0">
                        <a href="ListarPostagemConsumidor"
    ...
    <form name="AlterarConsumidor" action="AlterarConsumidor" method="POST">
      <div class="grid gap-6 mb-6 md:grid-cols-2 pt-32">
        <div>
          ...
          <input type="text"  id="nome" name="nomePessoa" value="${consumidor.nomePessoa}"
        ...
        <div>
          ...
          <input type="text" id="cpf"  name="cpfConsumidor" value="${consumidor.cpfConsumidor}"
            class="cpf border text-sm rounded-lg  block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-red-500 focus:border-red-500"
            placeholder="123.456.789-10" required>
        </div>
        <div>
          <label for="email" class="block mb-2 text-sm font-medium text-white">Login</label>
          <input type="text" id="email" name="loginPessoa" value="${consumidor.loginPessoa}"
        ...
        <div>
          ...
          <input type="text" id="password" name="senhaPessoa" value="${consumidor.senhaPessoa}"
            class=" border text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white"
            placeholder="•••••••••" required>
        </div>
        <div>
          <label for="CEP" class="block mb-2 text-sm font-medium text-white">CEP</label>
          <input type="text" id="cep" name="cepPessoa" onblur="pesquisacep(this.value);" value="${consumidor.cepPessoa}"
        ...
        <div>
          ...
          <input type="text" id="telefone" name="telefonePessoa" value="${consumidor.telefonePessoa}"
            ...
            placeholder="(11) 99111-1110" required>
                ...
                <input hidden="" name="enderecoPessoa" type="text" id="uf" value="${consumidor.estadoPessoa}">
                <input hidden="" type="text" name="cidadePessoa" id="cidade" value="${consumidor.cidadePessoa}">
                <input hidden="" type="text" name="enderecoPessoa" id="rua" value="${consumidor.enderecoPessoa}">
                <input hidden="" type="text" name="bairroPessoa" id="bairro" value="${consumidor.bairroPessoa}">
                <input hidden="" type="text" name="idPessoa" value="${consumidor.idPessoa}">
                <input hidden="" type="text" name="idConsumidor" value="${consumidor.idConsumidor}">
      <div>
