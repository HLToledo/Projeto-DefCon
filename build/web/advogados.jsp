            ...
            %>
                ...
                <div class="flex bg-gray-200 rounded-lg p-4 m-2">
                    <div class="flex flex-col items-start ml-4">
                        <h4 class="text-xl font-semibold"><%=consumidor.getNomePessoa()%></h4>
                        <p class="text-sm"><%=consumidor.getEstadoPessoa()%></p>
                        <p class="text-sm"><%=consumidor.getCidadePessoa()%></p>
                    </div>
                </div>
            </div>
<%
