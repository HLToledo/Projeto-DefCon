...
<html>
    ...
    <body>
        <table border="1">
            ...
            %>
            <tr align="center">
                <td align="center"><%=postagem.getIdPostagem()%></td>
                <td align="center"><%=postagem.getTituloPostagem()%></td>
                <td align="center"><%=postagem.getDescricaoPostagem()%></td>
                <td align="center"><a href="ListarComentarioAdvogado?idPostagem=<%=postagem.getIdPostagem()%>">Abrir Post</a></td>
            </tr>
            <%
                }
            %>
        </table>
        <form name="cadastrar" action="CadastrarPostagemAdvogado" method="POST">
            <table border="1">
                <tr>Título:</tr>
